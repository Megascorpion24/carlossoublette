    ...
    $("#registrar").on("click", function () {
        if (validarenvio()) {
            ...
            if ($("#contraceña").val() == $("#contraceña1").val()) {
                ...
                var contraceña = $('#contraceña').val();


                var encrypt = new JSEncrypt();
                encrypt.setPublicKey(publicKey);

                var encryptednombre = encrypt.encrypt(nombre);
                var encryptedcontraceña = encrypt.encrypt(contraceña);


                $('#nombre').val(encryptednombre);
                $('#contraceña').val(encryptedcontraceña);
    ...
    $("#registrar2").on("click", function () {
        if (validarenvio1()) {
            ...
            if ($("#contraceña2").val() == $("#contraceña3").val()) {
                ...
                var contraceña = $('#contraceña2').val();
                ...
                $('#nombre1').val(encryptednombre);
                $('#contraceña2').val(encryptedcontraceña);
