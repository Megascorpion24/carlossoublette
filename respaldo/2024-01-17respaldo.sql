...
-- Date: Wed, 17 Jan 2024 01:15:32 +0100
...
SET autocommit=0;
INSERT INTO `años` VALUES (1,'1','tarde',1),(2,'2','mañana',1),(3,'5','tarde',1),(4,'3','tarde',1),(5,'4','tarde',1);
...
SET autocommit=0;
INSERT INTO `ano_estudiantes` VALUES (18,1,'11111111'),(19,1,'22222222'),(20,1,'33333333'),(21,1,'30019081');
...
SET autocommit=0;
INSERT INTO `bitacora` VALUES (0,'2024-01-08','se registro un usuario','usuarios','2827479');
/*!40000 ALTER TABLE `bitacora` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `bitacora` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `deudas` VALUES (51,'11111111','inscripcion','2023-10-30',2229,1,0),(52,'22222222','mensualidad','2023-11-29',0,1,0),(53,'33333333','inscripcion','2023-08-30',2250,1,0),(54,'11111111','mensualidad','2023-11-30',1000,1,0),(55,'33333333','mensualidad','2024-01-08',20,1,1),(56,'30019081','inscripcion','2024-01-17',0,1,1);
/*!40000 ALTER TABLE `deudas` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `deudas` with 6 row(s)
--
...
SET autocommit=0;
INSERT INTO `estudiantes` VALUES ('11111111','hijomanuel','hijomanuel',22,'hijomanuel','aprobado',1,1),('22222222','hijojesus','hijojesus',11,'hijojesus','aprobado',23,1),('30019081','santiago','casamayor',16,'naas','aprobado',21,0),('33333333','otromanuel','otromanuel',23,'otromanuel','aprobado',1,1);
...
SET autocommit=0;
INSERT INTO `estudiantes_tutor` VALUES (5,'11111111','28621409'),(6,'22222222','28621408'),(7,'33333333','28621409'),(8,'30019081','28621409');
...
SET autocommit=0;
INSERT INTO `estudiante_ficha` VALUES (6,'11111111',6),(7,'22222222',7),(8,'33333333',8),(9,'30019081',9);
...
SET autocommit=0;
INSERT INTO `pagos` VALUES (3440,51,1112,'2023-10-30','2023-08-30','inscripcion','Transferencia',1111,1,'RETORNADO',1,0),(3443,54,2222,'2023-06-30','2023-05-30','mensualidad','Pago Movil',2222,2,'CONFIRMADO',1,0),(3456,53,1234,'2024-01-06','2023-08-30','inscripcion','Transf',2250,1,'Confirmado',0,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3134 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `rol_permiso` VALUES (2456,19,101),(2457,1,111),(2458,1,75),(2459,1,76),(2461,1,112),(3080,3,62),(3081,3,63),(3082,3,64),(3083,3,65),(3084,3,66),(3085,3,67),(3086,3,68),(3087,3,69),(3088,3,70),(3089,3,71),(3090,3,72),(3091,3,73),(3092,3,74),(3093,3,111),(3094,3,75),(3095,3,76),(3096,3,77),(3097,3,78),(3098,3,79),(3099,3,80),(3100,3,81),(3101,3,82),(3102,3,83),(3103,3,84),(3104,3,85),(3105,3,86),(3106,3,87),(3107,3,88),(3108,3,89),(3109,3,90),(3110,3,91),(3111,3,92),(3112,3,93),(3113,3,98),(3114,3,99),(3115,3,100),(3116,3,101),(3117,3,102),(3118,3,103),(3119,3,104),(3120,3,105),(3121,3,106),(3122,3,107),(3123,3,108),(3124,3,109),(3125,3,110),(3126,3,116),(3127,3,114),(3128,3,113),(3129,3,115),(3130,3,117),(3131,3,118),(3132,3,119),(3133,3,120);
...
SET autocommit=0;
INSERT INTO `secciones_años` VALUES (1,20,1,1,0),(5,23,1,2,0),(6,0,1,3,0),(7,23,2,1,0),(8,12,2,2,0),(9,12,2,3,0),(10,20,1,4,0),(11,20,1,5,0),(12,20,2,4,0),(13,20,2,5,0),(14,20,3,1,0),(15,20,3,2,0),(16,20,3,4,0),(17,20,3,5,0),(18,20,3,3,0),(19,20,4,1,0),(20,20,4,2,0),(21,20,4,4,0),(22,20,4,5,0),(23,20,4,3,0),(24,20,5,1,0),(25,20,5,2,0),(26,20,5,3,0),(27,20,5,5,0),(28,20,5,4,0),(29,19,1,1,0),(30,25,3,4,1),(31,0,0,1,1),(32,0,0,2,1),(33,0,0,5,1),(34,0,0,3,1),(35,0,0,3,1);
...
SET autocommit=0;
INSERT INTO `tutor_legal` VALUES ('28276731','jose','alejandro','rodriguez','sarmiento','00000000000','00000000000','jesusfob2021@gmail.com',0),('28276734','jose','alejandro','rodriguez','sarmiento','00000000000','00000000000','jesusfob2021@gmail.com',1),('28621408','jesus','jesus','jesus','jesus','33333333333','33333333333','jesus@gmail.com',1),('28621409','manuel','manuela','manuela','manuel','22222222221','22222222223','manuel@gmail.com',1),('30019081','santiago','elias','casamayor','machado','04125314169','04125314162','santiagocasamayor12@gmail.com',0);
/*!40000 ALTER TABLE `tutor_legal` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `tutor_legal` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `usuarios_tutor` VALUES (8,'28276734','28276734'),(9,'30019081','30019081');
...
-- Dump completed on: Wed, 17 Jan 2024 01:15:33 +0100
