...
-- Date: Thu, 01 Feb 2024 00:24:56 +0100
...
SET autocommit=0;
INSERT INTO `años_materias` VALUES (1,1,13),(2,3,14),(3,4,15),(4,2,16),(5,2,17);
...
SET autocommit=0;
INSERT INTO `ano_estudiantes` VALUES (21,1,'11111111'),(23,1,'22222222');
/*!40000 ALTER TABLE `ano_estudiantes` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ano_estudiantes` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `deudas` VALUES (57,'11111111','inscripcion','2023-10-30',0,1,1),(58,'11111111','mensualidad','2023-11-30',0,1,1),(61,'22222222','inscripcion','2023-08-30',0,1,1),(62,'22222222','mensualidad','2023-08-30',0,1,1);
...
SET autocommit=0;
INSERT INTO `estudiantes` VALUES ('11111111','Hijomanuel','Hijomanuel',14,'Ninguna','aprobado',19,1),('22222222','Hijojesus','Hijojesus',14,'Ninguna','aprobado',19,1);
/*!40000 ALTER TABLE `estudiantes` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `estudiantes` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `estudiantes_tutor` VALUES (8,'11111111','28621408'),(10,'22222222','28621409');
/*!40000 ALTER TABLE `estudiantes_tutor` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `estudiantes_tutor` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `estudiante_ficha` VALUES (9,'11111111',9),(11,'22222222',11);
/*!40000 ALTER TABLE `estudiante_ficha` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `estudiante_ficha` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `materias` VALUES (1,'ddddddddddddddddddd',0),(2,'historia',0),(3,'aaaaaaaaaaaa',0),(4,'soberania',0),(5,'asdasdddaaaaaaaaa',0),(6,'asdasdasd',0),(7,'asdasdasdddd',0),(8,'xxxxxxxxxxxx',0),(9,'ddddddddddddd',0),(10,'ssssssss',0),(11,'xzxzxzxzxzx',0),(12,'asdasddd',0),(13,'MATEMATICA',1),(14,'INGLES',0),(15,'INGLES',1),(16,'GAGAGA',0),(17,'HISTO RIA',1);
...
SET autocommit=0;
INSERT INTO `materias_docentes` VALUES (2,1,14,'000102'),(3,1,14,'000104'),(4,0,14,'30019081'),(5,1,15,'000104'),(6,1,15,'000105'),(7,1,15,'30019081'),(8,1,15,'30019082'),(9,0,16,'000103'),(10,0,16,'000104'),(11,0,13,'000105'),(12,0,13,'000103'),(13,0,13,'000102'),(14,0,13,'000104'),(15,0,13,'000101'),(16,0,15,'000101'),(17,1,17,'000101'),(18,1,17,'000102'),(20,1,17,'000103');
/*!40000 ALTER TABLE `materias_docentes` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `materias_docentes` with 18 row(s)
--
...
SET autocommit=0;
INSERT INTO `pagos` VALUES (3464,58,'1231','2024-01-18','2023-10-30','mensualidad','Transf',1500,'1','Confirmado',1,1),(3465,58,'1231','2024-01-18','2023-11-30','mensualidad','Pago Movil',1500,'1','Pendiente',1,1);
...
SET autocommit=0;
INSERT INTO `secciones` VALUES (0,'vacia',0),(1,'A',1),(2,'B',1),(3,'C',1),(4,'D',1),(5,'E',1),(6,'F',1),(7,'G',1),(8,'H',1),(9,'I',1),(10,'J',1),(11,'K',0),(12,'L',0),(13,'M',0),(14,'N',0),(15,'O',1),(16,'P',1),(17,'R',0),(18,'S',0),(19,'T',0),(20,'U',0),(21,'V',0);
...
SET autocommit=0;
INSERT INTO `secciones_años` VALUES (1,20,1,1,0),(5,23,1,2,0),(6,0,1,3,0),(7,23,2,1,0),(8,12,2,2,0),(9,12,2,3,0),(10,20,1,4,0),(11,20,1,5,0),(12,20,2,4,0),(13,20,2,5,0),(14,20,3,1,0),(15,20,3,2,0),(16,20,3,4,0),(17,20,3,5,0),(18,20,3,3,0),(19,20,4,1,0),(20,20,4,2,0),(21,20,4,4,0),(22,20,4,5,0),(23,20,4,3,0),(24,20,5,1,0),(25,20,5,2,0),(26,20,5,3,0),(27,20,5,5,0),(28,20,5,4,0),(29,19,1,1,0),(30,25,3,4,1),(31,0,0,1,1),(32,0,0,2,1),(33,0,0,5,1),(34,0,0,3,1),(35,0,0,3,1),(36,25,5,2,1),(37,25,9,5,1);
...
-- Dump completed on: Thu, 01 Feb 2024 00:24:58 +0100
