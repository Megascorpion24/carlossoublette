...
-- Date: Sun, 28 Jan 2024 08:38:23 -0400
...
SET autocommit=0;
INSERT INTO `años_materias` VALUES (1,0,1,13),(2,0,3,14),(3,0,5,15),(4,0,2,16),(5,0,1,17);
/*!40000 ALTER TABLE `años_materias` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `años_materias` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `ano_estudiantes` VALUES (21,1,'11111111'),(23,1,'22222222'),(24,1,'30019081'),(25,1,'30019082'),(26,1,'30019086');
/*!40000 ALTER TABLE `ano_estudiantes` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ano_estudiantes` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `deudas` VALUES (57,'11111111','inscripcion','2023-10-30',4500,1,1),(58,'11111111','mensualidad','2023-11-30',1500,1,1),(61,'22222222','inscripcion','2023-08-30',0,1,1),(62,'22222222','mensualidad','2023-08-30',0,1,1),(63,'30019081','inscripcion','2024-01-24',0,1,1),(64,'30019082','inscripcion','2024-01-28',0,1,1),(65,'30019082','mensualidad','2024-01-28',0,1,1),(66,'30019086','inscripcion','2024-01-28',0,1,1),(67,'30019086','mensualidad','2024-01-28',0,1,1);
/*!40000 ALTER TABLE `deudas` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `deudas` with 9 row(s)
--
...
SET autocommit=0;
INSERT INTO `docentes` VALUES ('000033','qweqwe','qweqwe','qweqwe','2023-07-20','qweqwe','qweqwe','12','12','dejesus2018@gmail.com','ElCercado',0),('000101','María','Rodríguez','Docente','1981-06-12','Historia','Licenciada','41','19','maria.rodriguez@example.com','Calle 101',1),('000102','Pedro','García','Docente','1974-09-25','Geografía','Licenciado','48','21','pedro.garcia@example.com','Calle 102',1),('000103','Laura','Martínez','Docente','1987-02-18','Biología','Licenciada','35','13','laura.martinez@example.com','Calle 103',1),('000104','Carlos','Fernández','Docente','1978-12-05','Química','Licenciado','44','17','carlos.fernandez@example.com','Calle 104',1),('000105','Sofía','Hernández','Docente','1983-04-30','Arte','Licenciada','39','16','sofia.hernandez@example.com','Calle 105',1),('000106','Antonio','Gómez','Docente','1979-10-15','Educación Física','Licenciado','43','18','antonio.gomez@example.com','Calle 106',1),('10773976','lucas','mendez','docente','1974-09-25','fisica','profesor','24','4','lucas23@gmail.com','carrera 15 entre 23 y 24',1),('300190123','santiago','casamayor','docente','2023-09-13','programacion','docevec','23','3','santiagocasamayor@gmail.com','sdaddas',0),('30019081','Luis','Perez','matematicas','2002','fisica','programador','21','2','santiagocasamayor14@gmail.com','calle51a entre 18 y 19',1),('30019082','Santiago','Casamayor','docente','1974-09-13','fisica','profesor','24','4','lucas23@gmail.com','carrera 15 entre 23 y 24',0);
...
SET autocommit=0;
INSERT INTO `docente_guia` VALUES (1,'000033',29),(2,'000103',30),(3,'000103',36);
...
SET autocommit=0;
INSERT INTO `docente_horario` VALUES (1,'000033',1),(2,'000033',2),(3,'000033',3),(4,'000033',4),(5,'000033',5),(6,'000033',6),(7,'30019081',7),(8,'30019081',8),(9,'30019081',9),(10,'000033',10),(11,'000033',16),(12,'000102',17),(13,'000102',18),(14,'000102',19),(15,'000102',20);
/*!40000 ALTER TABLE `docente_horario` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `docente_horario` with 15 row(s)
--
...
SET autocommit=0;
INSERT INTO `estudiantes` VALUES ('11111111','Hijomanuel','Hijomanuel',15,'Ninguna','aprobado',29,1),('22222222','Hijojesus','Hijojesus',14,'Ninguna','aprobado',19,1),('30019081','santiago','casamayor',16,'ninguna','ninguna',30,0),('30019082','santiago','casamayor',16,'ninguna','ninguna',30,1),('30019086','santiago','casamayor',16,'ninguna','ninguna',30,1);
/*!40000 ALTER TABLE `estudiantes` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `estudiantes` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `estudiantes_tutor` VALUES (8,'11111111','28621408'),(10,'22222222','28621409'),(11,'30019081','28621408'),(12,'30019082','28621408'),(13,'30019086','28621408');
/*!40000 ALTER TABLE `estudiantes_tutor` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `estudiantes_tutor` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `estudiante_ficha` VALUES (9,'11111111',9),(11,'22222222',11),(12,'30019081',12),(13,'30019082',13),(14,'30019086',14);
/*!40000 ALTER TABLE `estudiante_ficha` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `estudiante_ficha` with 5 row(s)
--
...
SET autocommit=0;
INSERT INTO `eventos` VALUES (1,'2023-12-02','2023-12-31','PrimerLapso',0,1),(2,'2023-12-02','2024-02-29','SegundoLapso',1,0),(3,'2023-12-02','2023-12-31','SegundoLapso',1,1);
/*!40000 ALTER TABLE `eventos` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `eventos` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `eventos_docente` VALUES (1,2,'000103'),(2,3,'000103');
/*!40000 ALTER TABLE `eventos_docente` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `eventos_docente` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `horario_ano` VALUES (1,1,17),(2,1,18),(3,1,19),(4,1,20);
/*!40000 ALTER TABLE `horario_ano` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `horario_ano` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `horario_docente` VALUES (17,'13:00:00','14:00:00',3,'2024-01-01','2024-01-31',30,1),(18,'15:39:00','17:39:00',2,'2024-01-01','2024-01-31',30,1),(19,'12:22:00','14:30:00',1,'2024-01-01','2024-01-31',30,0),(20,'13:00:00','14:00:00',4,'2024-01-01','2024-01-31',30,1);
/*!40000 ALTER TABLE `horario_docente` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `horario_docente` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `materias_docentes` VALUES (1,1,13,'30019082'),(2,1,14,'000102'),(3,1,14,'000104'),(4,0,14,'30019081'),(9,0,15,'000101'),(10,0,15,'000103'),(11,0,16,'000101'),(12,0,16,'000103'),(13,0,17,'000101'),(14,0,17,'000103');
...
SET autocommit=0;
INSERT INTO `materia_horario_docente` VALUES (1,3,1),(2,2,2),(3,1,3),(4,2,4),(5,3,5),(6,1,6),(7,4,7),(8,2,8),(9,3,9),(10,1,10),(11,2,16),(12,15,17),(13,5,18),(14,15,19),(15,13,20);
/*!40000 ALTER TABLE `materia_horario_docente` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `materia_horario_docente` with 15 row(s)
--
...
) ENGINE=InnoDB AUTO_INCREMENT=3138 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `rol_permiso` VALUES (2456,19,101),(2457,1,111),(2458,1,75),(2459,1,76),(2461,1,112),(3080,3,62),(3081,3,63),(3082,3,64),(3083,3,65),(3084,3,66),(3085,3,67),(3086,3,68),(3087,3,69),(3088,3,70),(3089,3,71),(3090,3,72),(3091,3,73),(3092,3,74),(3094,3,75),(3095,3,76),(3096,3,77),(3097,3,78),(3098,3,79),(3099,3,80),(3100,3,81),(3101,3,82),(3102,3,83),(3103,3,84),(3104,3,85),(3105,3,86),(3106,3,87),(3107,3,88),(3108,3,89),(3109,3,90),(3110,3,91),(3111,3,92),(3112,3,93),(3113,3,98),(3114,3,99),(3115,3,100),(3116,3,101),(3117,3,102),(3118,3,103),(3119,3,104),(3120,3,105),(3121,3,106),(3122,3,107),(3123,3,108),(3124,3,109),(3125,3,110),(3126,3,116),(3127,3,114),(3128,3,113),(3129,3,115),(3130,3,117),(3131,3,118),(3132,3,119),(3133,3,120),(3134,3,121),(3135,3,122),(3136,1,121),(3137,24,106);
...
SET autocommit=0;
INSERT INTO `secciones_años` VALUES (1,20,1,1,0),(5,23,1,2,0),(6,0,1,3,0),(7,23,2,1,0),(8,12,2,2,0),(9,12,2,3,0),(10,20,1,4,0),(11,20,1,5,0),(12,20,2,4,0),(13,20,2,5,0),(14,20,3,1,0),(15,20,3,2,0),(16,20,3,4,0),(17,20,3,5,0),(18,20,3,3,0),(19,20,4,1,0),(20,20,4,2,0),(21,20,4,4,0),(22,20,4,5,0),(23,20,4,3,0),(24,20,5,1,0),(25,20,5,2,0),(26,20,5,3,0),(27,20,5,5,0),(28,20,5,4,0),(29,19,1,1,0),(30,24,3,4,1),(31,0,0,1,1),(32,0,0,2,1),(33,0,0,5,1),(34,0,0,3,1),(35,0,0,3,1),(36,25,1,2,1);
...
SET autocommit=0;
INSERT INTO `tutor_legal` VALUES ('10773956','lucas','mendez','marinez','mujica','04244572134','04123456781','lucas23@gmail.com','',1),('28621408','jorge','mendez','camilo','mujica','04244572134','04123456781','lucas23@gmail.com','',1),('28621409','Jesus','Jesus','Jesus','Jesus','53453453453','53453453453','asdasda@gmail.com','',0);
...
SET autocommit=0;
INSERT INTO `usuarios` VALUES ('10773956','lucas','lucas23@gmail.com','$2y$10$YpvbZR0HnjBAI5z.GY7rouPkFtqJHsLINf7VUmdkhSeaodQYXk4Qi','1',19),('2827479','admin','jesusfob2021@gmail.com','$2y$10$psNZjqnhFQ8X/cBymADfhOpcHzvrzgwn213EOHkWzj8j/pUpSOu1a','1',3),('28276731','asdasddd','jesusfob2021@gmail.com','$2y$10$sGOAx2JIvBjaSoAlCdzPguPuXZQWd.TEsMc81m.RwFHuwatTTUrTG','1',3),('28621408','arepa','santi@gmail.com','marial2','1',1),('28621409','Jesus','asdasda@gmail.com','$2y$10$3vHV.p2WAVG.WiO2r1QrRO7J7NK8OVdqtK7FajzTZ8btyCSVieCuO','0',1),('30019084','arepa','santi@gmail.com','$2y$10$DMO9d/nx8oibwrUe4BuURO8uk4uvENXqNn4EqnIXuxWNIofo8Jsz.','1',1);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `usuarios` with 6 row(s)
--
...
SET autocommit=0;
INSERT INTO `usuarios_tutor` VALUES (9,'28621408','28621408'),(10,'28621409','28621409'),(11,'10773956','10773956');
...
-- Dump completed on: Sun, 28 Jan 2024 08:38:25 -0400
