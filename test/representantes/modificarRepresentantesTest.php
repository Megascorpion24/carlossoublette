...
class modificarRepresentantesTest extends TestCase{
	...
	public function testModificacionExitosa(){
		...
		$this->assertEquals("2REGISTRO MODIFICADO", $this->representante->modificar1($this->representante));
	}
    ...
    public function testModificacionFallida(){
		...
		$this->assertEquals("4PAGO NO REGISTRADO", $this->representante->modificar1($this->representante));
	}
