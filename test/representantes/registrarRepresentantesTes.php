...
class registrarRepresentantesTest extends TestCase{
	...
	public function testRegistroExitoso(){
		...
		$this->assertEquals("Registro Incluido", $this->representante->registrar1($this->representante));
	}
    ...
    public function testRegistroFallido(){
		...
		$this->assertEquals("Cedula Registrada", $this->representante->registrar1($this->representante));
	}
