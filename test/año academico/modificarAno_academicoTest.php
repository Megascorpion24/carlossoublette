...
class modificarAno_academicoTest extends TestCase{
	...
	public function testModificacionExitoso(){
        $this->ano_academico->set_id("1");
         $this->ano_academico->set_fecha_cierr("2024-01-31");
        $this->ano_academico->set_fecha_ini("2024-01-01");
        $this->ano_academico->set_ano_academico("2023-2024");
        $this->ano_academico->set_nivel("1");
		$this->assertEquals("2Registro modificado", $this->ano_academico->modificar($this->ano_academico));
	}
    ...
    public function testModificacionfallido(){
        ...
        $this->ano_academico->set_nivel("1");
		$this->assertEquals("4Año no registrado", $this->ano_academico->modificar($this->ano_academico));
	}
