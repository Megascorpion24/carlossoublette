    ...
    $co = $this->conecta();
        ...
        try{
           ...
           $ano="";
			...
			$resultado = $co->prepare("SELECT COUNT(estudiantes.cedula) cantidad FROM estudiantes INNER JOIN ano_estudiantes on ano_estudiantes.id_ano =$ano INNER JOIN secciones_años ON estudiantes.id_anos_secciones=secciones_años.id WHERE estudiantes.cedula=ano_estudiantes.id_estudiantes and estudiantes.estado=0 and secciones_años.id_anos=1");
			$resultado->execute();
           $ano="";
    ...
    $co = $this->conecta();
        ...
        try{
           ...
           $ano="";
			...
			$resultado = $co->prepare("SELECT COUNT(estudiantes.cedula) cantidad FROM estudiantes INNER JOIN ano_estudiantes on ano_estudiantes.id_ano =$ano INNER JOIN secciones_años ON estudiantes.id_anos_secciones=secciones_años.id WHERE estudiantes.cedula=ano_estudiantes.id_estudiantes and estudiantes.estado=0 and secciones_años.id_anos=2");
			$resultado->execute();
           $ano="";
    ...
    $co = $this->conecta();
        ...
        try{
           ...
           $ano="";
			...
			$resultado = $co->prepare("SELECT COUNT(estudiantes.cedula) cantidad FROM estudiantes INNER JOIN ano_estudiantes on ano_estudiantes.id_ano =$ano INNER JOIN secciones_años ON estudiantes.id_anos_secciones=secciones_años.id WHERE estudiantes.cedula=ano_estudiantes.id_estudiantes and estudiantes.estado=0 and secciones_años.id_anos=4");
			$resultado->execute();
           $ano="";
    ...
    $co = $this->conecta();
        ...
        try{
           ...
           $ano="";
			...
			$resultado = $co->prepare("SELECT COUNT(estudiantes.cedula) cantidad FROM estudiantes INNER JOIN ano_estudiantes on ano_estudiantes.id_ano =$ano INNER JOIN secciones_años ON estudiantes.id_anos_secciones=secciones_años.id WHERE estudiantes.cedula=ano_estudiantes.id_estudiantes and estudiantes.estado=0 and secciones_años.id_anos=5");
			$resultado->execute();
           $ano="";
...
public function consultar5(){
    $co = $this->conecta();
        ...
        try{
           ...
           $ano="";
			...
			$resultado = $co->prepare("SELECT COUNT(estudiantes.cedula) cantidad FROM estudiantes INNER JOIN ano_estudiantes on ano_estudiantes.id_ano =$ano INNER JOIN secciones_años ON estudiantes.id_anos_secciones=secciones_años.id WHERE estudiantes.cedula=ano_estudiantes.id_estudiantes and estudiantes.estado=0 and secciones_años.id_anos=3");
			$resultado->execute();
           $ano="";
	...
	public function consultar6(){
		$co = $this->conecta();
			...
			$co->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			try{
				$resultado = $co->prepare("SELECT * FROM `montos` WHERE 1");
			...
			foreach($resultado as $r){
			   ...
			   $i=0;
				...
				foreach($resultado as $r){
					$date1 = date('Y-m-d');
						$dater = date_parse($date1);
						$datet = date_parse($r['fecha']);
					if ($r['concepto']=="mensualidad") {
					...
					if ($diff->m >= 0 && $dater['month'] == $datet['month'] && $dater['year'] == $datet['year'] ) {
						...
						$respuesta=$respuesta."<th>".$mul."</th>";
						$respuesta= $respuesta.'</tr>';
						$count++;
					}
			
					}if ($r['concepto']=="inscripcion" && $dater['month'] == $datet['month'] && $dater['year'] == $datet['year'] ) {
					
						$respuesta=$respuesta.'<tr>';
                		$respuesta=$respuesta."<th>"."inscripcion"."</th>";
						$respuesta=$respuesta."<th>".$ins."</th>";
						$respuesta= $respuesta.'</tr>';
						$count++;
					}
	...
	public function consultar7(){
		$co = $this->conecta();
			...
			foreach($resultado as $r){
				...
				$resultado = $co->prepare("SELECT * FROM `pagos` WHERE estado_pagos=1 and pagos.estado='CONFIRMADO' and pagos.estatus=1");
				//<!----------SELECT * from deudas WHERE estado_deudas = 1-------------------->
				$resultado->execute();
			   $respuesta="";
			   $respuesta2="";
			   ...
			   $i=0;
				...
				foreach($resultado as $r){
					...
					$date1 = date('Y-m-d');
						$dater = date_parse($date1);
						$datet = date_parse($r['fecha']);
					if ($r['concepto']=="mensualidad" && $dater['month'] == $datet['month'] && $dater['year'] == $datet['year'] ) {
			...
			foreach($resultado as $r){
			   ...
			   $i=0;
				...
				foreach($resultado as $r){
					...
					}if ($r['concepto']=="inscripcion" && $dater['year'] == $datet['year'] ) {
			   ...
			   $i=0;
				...
				foreach($resultado as $r){
					...
					$date1 = date('Y-m-d');
						$dater = date_parse($date1);
						$datet = date_parse($r['fecha']);
					if ($r['concepto']=="mensualidad" && $dater['year'] == $datet['year'] ) {
