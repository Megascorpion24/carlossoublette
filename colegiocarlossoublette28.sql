...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2023 a las 05:09:46
...
--
-- Base de datos: `colegiocarlossoublette28`
--
...
(2, '2023-09-07', '2024-04-11', 'Estudios', '2021-2022', 0);
...
(1173, '2023-11-16', 'se modifico un pago', 'docentes', 27),
(1174, '2023-11-16', 'se modifico un pago', 'docentes', 27),
(1175, '2023-11-16', 'se registró una materia', 'materias', 27),
(1176, '2023-11-16', 'se modificó Docente de una materia', 'materias', 27),
(1177, '2023-11-16', 'se modificó Docente de una materia', 'materias', 27),
(1178, '2023-11-16', 'se modificó Docente de una materia', 'materias', 27),
(1179, '2023-11-16', 'se registró una materia', 'materias', 27),
(1180, '2023-11-16', 'se registró una materia', 'materias', 27),
(1181, '2023-11-16', 'se registro una seccion', 'secciones', 27),
(1182, '2023-11-16', 'se Actualizo el Abecedario de secciones', 'secciones', 27),
(1183, '2023-11-16', 'se registro una seccion', 'secciones', 27),
(1184, '2023-11-16', 'se registro una seccion', 'secciones', 27),
(1185, '2023-11-21', 'se modificó Docente de una materia', 'materias', 27),
(1186, '2023-11-21', 'se Actualizo el Abecedario de secciones', 'secciones', 27),
(1187, '2023-11-21', 'se registro una seccion', 'secciones', 27),
(1188, '2023-11-21', 'se registro un año academico', 'ano_academico', 27),
(1189, '2023-11-21', 'se registro una seccion', 'secciones', 27);
...
('11111111', 'hijomanuel', 'hijomanuel', 22, 'hijomanuel', 'aprobado', 34, 1),
('1213141', 'Luis', 'Cruz', 13, 'Participa en actividades sociales', 'Aprobado', 30, 1),
('1234567', 'Juan', 'Pérez', 16, 'Buen estudiante', 'Aprobado', 30, 1),
('1516171', 'Elena', 'Ortega', 17, 'Interesada en biología', 'Aprobado', 30, 1),
('1819201', 'Mario', 'Ramírez', 14, 'Le gusta la música', 'Aprobado', 30, 1),
('2122231', 'Marta', 'Torres', 16, 'Buen desempeño académico', 'Aprobado', 30, 1),
('22222222', 'hijojesus', 'hijojesus', 11, 'hijojesus', 'aprobado', 23, 1),
('33333333', 'otromanuel', 'otromanuel', 23, 'otromanuel', 'aprobado', 34, 1);
...
INSERT INTO `materias_docentes` (`id`, `id_materias`, `id_docente`) VALUES
(1, 13, '30019082'),
(2, 14, '000102'),
(3, 14, '000104'),
(4, 14, '30019081'),
