...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2023 a las 17:09:39
...
(1015, '2023-10-29', 'se registro un representante', 'representantes', 27),
(1016, '2023-10-29', 'se registro un representante', 'representantes', 27),
(1017, '2023-10-29', 'se inscribio un estudiante', 'inscripciones', 27),
(1018, '2023-10-29', 'se inscribio un estudiante', 'inscripciones', 27),
(1019, '2023-10-29', 'se inscribio un estudiante', 'inscripciones', 27),
(1020, '2023-10-29', 'se registro un pago', 'docentes', 32),
(1021, '2023-10-29', 'se registro un pago', 'docentes', 32),
(1022, '2023-10-29', 'se registro un pago', 'docentes', 31),
(1023, '2023-10-29', 'se modifico un pago', 'docentes', 27);
...
(6, '33333333', '650', 'inscripcion', '2023-10-29', 1, 1),
(7, '22222222', '0', 'inscripcion', '2023-10-29', 1, 0),
(8, '11111111', '0', 'inscripcion', '2023-10-29', 1, 0);
...
('11111111', 'Hijojesus', 'awdasdawd', 33, 'awdasdawd', 'aprobado', 7, 1),
('22222222', 'Hijomanuel', 'awdasdawd', 22, 'awdasdawd', 'reprovado', 1, 1),
('33333333', 'Hijomanuel', 'asdadasdasd', 22, 'asdadas', 'aprobado', 1, 1);
...
(5, 'asdadas', 'asdadas', 'asdadas', 'asdadas', 'asdadas', 'asdadas', 'asdadas', 'asdadas'),
(6, 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd'),
(7, 'awdasdawd', 'awdasdawa', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd', 'awdasdawd');
...
CREATE TABLE `pagos` (
  `id` int(11) NOT NULL,
  `id_deudas` int(5) NOT NULL,
  `identificador` varchar(10) NOT NULL,
  `fecha` varchar(50) NOT NULL,
  `concepto` varchar(20) NOT NULL,
  `forma` varchar(20) NOT NULL,
  `monto` varchar(2) NOT NULL,
...
INSERT INTO `pagos` (`id`, `id_deudas`, `identificador`, `fecha`, `concepto`, `forma`, `monto`, `estado`, `estado_pagos`, `estatus`) VALUES
(3335, 7, '1231', '2023-10-29', 'inscripcion', 'Transferencia', '65', 'PENDIENTE', 0, 1),
(3336, 8, '1333', '2023-10-29', 'inscripcion', 'Efectivo', '65', 'PENDIENTE', 1, 1);
...
CREATE TABLE `tutor_legal` (
  ...
  `contacto_emer` varchar(11) NOT NULL,
...
('123123123', 'asdasd', 'asdasd', '', 'asdasd', '21132132131', '312132131', 'asdasdasdasd', 1),
('28276732', 'jose', 'alejandro', '', 'sarmiento', '00000000000', '00000000000', 'jesusfob2021@gmail.com', 0),
('28621408', 'Jesus', 'asda', 'asda', 'asda', '23123123123', '12312231231', 'sadasd@gmail.com', 1),
('28621409', 'manuel', 'asdad', 'asdasd', 'asdas', '13123123123', '12312312311', 'sdasdas@gmail.com', 1),
('312312131', 'jose', 'alejandro', '', 'sarmiento', '00000000000', '00000000000', 'jesus2021fob@gmail.com', 1);
...
(30, 'iiiiiiiiiiiiiiiiiiii', 'asdasdasda@gmail.com', '$2y$10$sSRkAGFyyIsGuk9hvuHsIeEpolEFz89cssnP5I9oLXYJWpOf/mA52', '1', 19),
(31, 'Jesus', 'sadasd@gmail.com', '$2y$10$q8ypoqYtST5kMeU4HvpWiOR7KOwOMihuZHhtMTEnrzfPj8NAiCa/2', '1', 1),
(32, 'manuel', 'sdasdas@gmail.com', '$2y$10$KCBECyxLk7KrHdjfTLk6SemTR7ovzM1mIk0KSrVNijPyM0ZhZqFZe', '1', 1);
